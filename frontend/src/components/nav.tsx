        ...
        <header className="w-full flex justify-between items-center px-5">
          ...
          <div className="ml-5 relative">
            <input
              ...
              className="w-60 md:w-96 px-6 py-2 rounded-xl bg-neutral-800 text-white border border-gray-700 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
